...
static char moveit_task_constructor_msgs__msg__SubSolution__FIELD_NAME__info[] = "info";
static char moveit_task_constructor_msgs__msg__SubSolution__FIELD_NAME__sub_solution_id[] = "sub_solution_id";

static rosidl_runtime_c__type_description__Field moveit_task_constructor_msgs__msg__SubSolution__FIELDS[] = {
  {
    {moveit_task_constructor_msgs__msg__SubSolution__FIELD_NAME__info, 4, 4},
    {
  ...
  {
    {moveit_task_constructor_msgs__msg__SubSolution__FIELD_NAME__sub_solution_id, 15, 15},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription moveit_task_constructor_msgs__msg__SubSolution__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {moveit_task_constructor_msgs__msg__SubSolution__FIELDS, 2, 2},
    },
    {moveit_task_constructor_msgs__msg__SubSolution__REFERENCED_TYPE_DESCRIPTIONS, 13, 13},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[6].fields = moveit_task_constructor_msgs__msg__SolutionInfo__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[7].fields = sensor_msgs__msg__CompressedImage__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[11].fields = visualization_msgs__msg__MeshFile__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[12].fields = visualization_msgs__msg__UVCoordinate__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
moveit_task_constructor_msgs__msg__SubSolution__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *moveit_task_constructor_msgs__msg__SubSolution__get_individual_type_description_source(NULL),
    ...
    sources[7] = *moveit_task_constructor_msgs__msg__SolutionInfo__get_individual_type_description_source(NULL);
    sources[8] = *sensor_msgs__msg__CompressedImage__get_individual_type_description_source(NULL);
    ...
    sources[12] = *visualization_msgs__msg__MeshFile__get_individual_type_description_source(NULL);
    sources[13] = *visualization_msgs__msg__UVCoordinate__get_individual_type_description_source(NULL);
    constructed = true;
  }
