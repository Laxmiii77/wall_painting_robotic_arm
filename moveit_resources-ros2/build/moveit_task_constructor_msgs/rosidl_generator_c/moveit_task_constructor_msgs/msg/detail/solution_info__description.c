...
static char moveit_task_constructor_msgs__msg__SolutionInfo__FIELD_NAME__id[] = "id";
static char moveit_task_constructor_msgs__msg__SolutionInfo__FIELD_NAME__cost[] = "cost";
static char moveit_task_constructor_msgs__msg__SolutionInfo__FIELD_NAME__comment[] = "comment";
static char moveit_task_constructor_msgs__msg__SolutionInfo__FIELD_NAME__stage_id[] = "stage_id";
static char moveit_task_constructor_msgs__msg__SolutionInfo__FIELD_NAME__planner_id[] = "planner_id";
static char moveit_task_constructor_msgs__msg__SolutionInfo__FIELD_NAME__markers[] = "markers";

static rosidl_runtime_c__type_description__Field moveit_task_constructor_msgs__msg__SolutionInfo__FIELDS[] = {
  {
    {moveit_task_constructor_msgs__msg__SolutionInfo__FIELD_NAME__id, 2, 2},
    {
  ...
  {
    {moveit_task_constructor_msgs__msg__SolutionInfo__FIELD_NAME__cost, 4, 4},
    {
  ...
  {
    {moveit_task_constructor_msgs__msg__SolutionInfo__FIELD_NAME__comment, 7, 7},
    {
  ...
  {
    {moveit_task_constructor_msgs__msg__SolutionInfo__FIELD_NAME__stage_id, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT32,
      0,
      0,
  ...
  {
    {moveit_task_constructor_msgs__msg__SolutionInfo__FIELD_NAME__planner_id, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  {
    {moveit_task_constructor_msgs__msg__SolutionInfo__FIELD_NAME__markers, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription moveit_task_constructor_msgs__msg__SolutionInfo__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {moveit_task_constructor_msgs__msg__SolutionInfo__FIELDS, 6, 6},
    },
    {moveit_task_constructor_msgs__msg__SolutionInfo__REFERENCED_TYPE_DESCRIPTIONS, 12, 12},
  };
  if (!constructed) {
...
moveit_task_constructor_msgs__msg__SolutionInfo__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *moveit_task_constructor_msgs__msg__SolutionInfo__get_individual_type_description_source(NULL),
